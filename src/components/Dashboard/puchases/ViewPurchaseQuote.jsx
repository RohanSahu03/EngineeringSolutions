...
function ViewPurchaseQuotation() {
  // const {id}=useParams()
    ...
    if (recdata == "Approved") {
      try {
        const res = await axios.put(
          `https://engineeringsolutions.net.in/api/purchasequotation/updateQuote/${receivedData?._id}`,
          { status: "Approved" }
        );
        if (res.status === 201) {
      ...
      <section className="mt-3" id="pdf-content">
        <div className="container border p-5">
          ...
          <div class="row">
            ...
            <div className="col-md-3 text-start">{quotedata?.quote}</div>
          </div>
          <div class="row">
            <div className="col-md-3 text-start">
              <p>
            ...
            <div className="col-md-3 text-start">
              {formatDate(receivedData?.quotedate)}
            </div>
          </div>
          <div class="row">
            <div className="col-md-3 text-start">
          ...
          >
            <div className="col-md-8 ">
              <p>
                <b>Quotation From:</b>
                <br />
                Mr./Mrs. {quotedata?.vendorname?.vendorfirstname} &nbsp;{" "}
                {quotedata?.vendorname?.vendorlastname}
                <br />
            ...
            <div className="col-md-10 text-start">
              <p>
                <b>{quotedata && quotedata?.customername?.customerfirstname}</b>
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-7  text-start">
              <div className="row">
                ...
                <p>
                  <i>
                    <b>
                      Indian rupee {numberToWords(Number(quotedata?.total))}{" "}
                      only
                    </b>
                  </i>
                </p>
            ...
            <div className="col-md-4">
              ...
              <div className="row">
                ...
                <div className="col-md-6  text-end">
                  ₹ {quotedata && quotedata.shippingcharges}
                </div>
              </div>
