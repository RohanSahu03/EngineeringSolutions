      ...
      <section className="mt-3" id="pdf-content">
        <div className="container border p-5">
          ...
          <div class="row">
            ...
            <div className="col-md-3 text-start">
              {formatDate(listofquote?.expirydate)}
            </div>
          </div>
          <div class="row">
            <div className="col-md-3 text-start">
            ...
            <div className="col-md-12 mt-2 text-start">
              <p>
                  ...
                  {listofquote &&
                    ...
                    <br />
                    {listofquote?.customername?.billingaddressstate}
                    <br />
                    {listofquote?.customername?.billingaddresspincode}
