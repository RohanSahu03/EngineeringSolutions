          ...
          <div className="container border p-5">
            ...
            <div className="row">
                  ...
                  <div class="row">
                    ...
                    <div className="col-md-9 text-start">
                      <b>
                        <i>
                          indian rupee{" "}
                          {numberToWords(receivedData?.amountreceived)} Only
                        </i>
                      </b>
                    </div>
                  </div>
              ...
              <div className="col-md-3">
                ...
                >
                  <b>Amount Received</b>
                  <span>₹ {(receivedData?.amountreceived).toFixed(2)}</span>
                </div>
              </div>
            </div>
            <div className="row mt-5">
              <div className="col-md-6">
                <div class="row">
                  ...
                  <div className="col-md-9 text-start">
                    <b>{receivedData?.customername?.customerfirstname}</b>
                  </div>
                </div>
              </div>
            ...
            <div className="row text-start mt-3">
              <div className="col-md-3">
                <p>
                  <b> Over Payment : </b>₹{" "}
                  {(
                    receivedData?.amountreceived - receivedData?.usedamount
                  ).toFixed(2)}
                </p>
              </div>
            </div>
