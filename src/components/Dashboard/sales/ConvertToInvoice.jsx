...
function ConvertToInvoice() {
  ...
  const saveInvoice = async () => {
    ...
    formdata.set("salesorderid", receivedData._id);
    formdata.set("customername", receivedData.customername._id);
    formdata.set("invoice", invoice);
    formdata.set("ordernumber", receivedData.salesorder);
    formdata.set("invoicedate", invoicedate);
    formdata.set("duedate", duedate);
    formdata.set("terms", receivedData.paymentterm);
  ...
  const confirmalert = () => {
    confirmAlert({
      ...
      message:
        "The sales order will be automatically confirmed once you convert it to an invoice",
      buttons: [
        {
          label: "Yes",
          onClick: () => {
