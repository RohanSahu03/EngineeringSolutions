    ...
    if (recdata == "Approved") {
      try {
        const res = await axios.put(
          `https://engineeringsolutions.net.in/api/inventory/updategrn/${receivedData?._id}`,
          { status: "Checked" }
        );
        if (res.status === 201) {
  ...
  const getInspectionById = async () => {
    try {
      const res = await axios.get(
        `https://engineeringsolutions.net.in/api/inventory/getgrnbyid/${receivedData?._id}`
      );
      if (res.status === 201) {
      ...
      <section className="mt-3" id="pdf-content">
        <div className="container border p-5">
          ...
          <div class="row">
            ...
            <div className="col-md-3 text-start">{quotedata?.grnno}</div>
          ...
          <div class="row">
            ...
            <div className="col-md-3 text-start">{quotedata?.inspectionno}</div>
            ...
            <div className="col-md-3 text-start">{quotedata?.challanno}</div>
          </div>
          <div class="row">
            <div className="col-md-3 text-start">
              <p>
            ...
            <div className="col-md-3 text-start">
              {formatDate(quotedata?.inspectiondate)}
            </div>
            ...
            <div className="col-md-3 text-start">
              {formatDate(quotedata?.challandate)}
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div className="col-md-3 text-start">{quotedata?.pono}</div>
          ...
          >
            <div className="col-md-8 ">
              <p>
                ...
                <br />
                {quotedata?.vendorname?.companyname}
                <br />
                {quotedata?.vendorname?.vendoremail}
                <br />
                {quotedata?.vendorname?.vendorphone}
              </p>
            </div>
            <div className="col-md-10 text-start">
              <p>
                <b>{quotedata?.customername?.customerfirstname}</b>
              </p>
            </div>
          </div>
