  ...
  const getInspectionById = async () => {
    try {
      const res = await axios.get(
        `https://engineeringsolutions.net.in/api/inventory/getgriforcashbyid/${receivedData?._id}`
      );
      if (res.status === 201) {
      ...
      <section className="mt-3" id="pdf-content">
        <div className="container border p-5">
          ...
          <div class="row">
            ...
            <div className="col-md-3 text-start">{quotedata?.indentno}</div>
            ...
            <div className="col-md-3 text-start">
              {formatDate(quotedata?.indentdate)}
            </div>
          </div>
