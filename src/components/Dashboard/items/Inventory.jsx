  ...
  const getAllProducts = async () => {
    try {
      const res = await axios.get(
        "https://engineeringsolutions.net.in/api/inventory/getinventory"
      );
  ...
  const deleteItem = async (id) => {
    try {
      const res = await axios.delete(
        `https://engineeringsolutions.net.in/api/inventory/deleteinventory/${id}`
      );
      if (res.status === 200) {
        getAllProducts();
                    ...
                    return (
                      <tr key={item._id}>
                        ...
                        <td className="text-center">
                          <FaEye
                            onClick={() =>
                              navigate("/dashboard/inventory/viewInventory", {
                                state: item,
                              })
                            }
                          />
            ...
            <div className="row mt-2 g-3 align-items-center">
              ...
              <div className="col-md-5">
                <input
                  ...
                  value={productname}
                  placeHolder={selecteItem?.productname}
                />
              </div>
            </div>
              ...
              <div className="col-md-5 ">
                <div class="input-group mb-3 textInput">
                  ...
                  <input
                    ...
                    value={purchaseprice}
                    placeHolder={selecteItem?.purchaseprice}
                  />
                </div>
              </div>
            </div>
